import{n as ee}from"./rolldown-runtime-QTnfLwEv.js";import{t as e}from"./shaderStore-D-XQlhUT.js";import"./sceneFragmentDeclaration-Dd0MHHyX.js";import"./oitFragment-30xE3MIN.js";import"./mainUVVaryingDeclaration-B0MsBTDj.js";import"./hdrFilteringFunctions-DPR-QGQi.js";import"./pbrBRDFFunctions-9YzmZNQz.js";import"./harmonicsFunctions-quK3ezjV.js";var t=`pbrFragmentDeclaration`,te=`uniform vec4 vEyePosition;uniform vec3 vReflectionColor;uniform vec4 vAlbedoColor;uniform float baseWeight;uniform float baseDiffuseRoughness;uniform vec4 vLightingIntensity;uniform vec4 vReflectivityColor;uniform vec4 vMetallicReflectanceFactors;uniform vec3 vEmissiveColor;uniform float visibility;uniform vec3 vAmbientColor;
#ifdef ALBEDO
...
`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=te);var n=`pbrFragmentExtraDeclaration`,r=`varying vec3 vPositionW;
#if DEBUGMODE>0
...
#endif
#endif
`;e.IncludesShadersStore[i]||(e.IncludesShadersStore[i]=a);var o=`pbrFragmentSamplersDeclaration`,ne=`#include<samplerFragmentDeclaration>(_DEFINENAME_,ALBEDO,_VARYINGNAME_,Albedo,_SAMPLERNAME_,albedo)
...
#endif
`;e.IncludesShadersStore[o]||(e.IncludesShadersStore[o]=ne);var s=`subSurfaceScatteringFunctions`,c=`bool testLightingForSSS(float diffusionProfile)
...
#endif
`;e.IncludesShadersStore[l]||(e.IncludesShadersStore[l]=u);var d=`pbrDirectLightingSetupFunctions`,f=`struct preLightingInfo
...
#endif
`;e.IncludesShadersStore[d]||(e.IncludesShadersStore[d]=f);var p=`pbrDirectLightingFalloffFunctions`,re=`float computeDistanceLightFalloff_Standard(vec3 lightOffset,float range)
...
#endif
}`;e.IncludesShadersStore[p]||(e.IncludesShadersStore[p]=re);var m=`pbrDirectLightingFunctions`,ie=`#define CLEARCOATREFLECTANCE90 1.0
struct lightingInfo
{vec3 diffuse;
...
#endif
`;e.IncludesShadersStore[m]||(e.IncludesShadersStore[m]=ie);var h=`pbrIBLFunctions`,g=`#if defined(REFLECTION) || defined(SS_REFRACTION)
...
#endif
`;e.IncludesShadersStore[h]||(e.IncludesShadersStore[h]=g);var _=`pbrBlockAlbedoOpacity`,v=`struct albedoOpacityOutParams
...
`;e.IncludesShadersStore[_]||(e.IncludesShadersStore[_]=v);var y=`pbrBlockReflectivity`,b=`struct reflectivityOutParams
...
`;e.IncludesShadersStore[y]||(e.IncludesShadersStore[y]=b);var x=`pbrBlockAmbientOcclusion`,S=`struct ambientOcclusionOutParams
{vec3 ambientOcclusionColor;
...
`;e.IncludesShadersStore[x]||(e.IncludesShadersStore[x]=S);var C=`pbrBlockAlphaFresnel`,ae=`#ifdef ALPHAFRESNEL
...
#endif
#endif
`;e.IncludesShadersStore[C]||(e.IncludesShadersStore[C]=ae);var w=`pbrBlockAnisotropic`,oe=`#ifdef ANISOTROPIC
...
#endif
`;e.IncludesShadersStore[w]||(e.IncludesShadersStore[w]=oe);var T=`pbrBlockReflection`,se=`#ifdef REFLECTION
...
#endif
`;e.IncludesShadersStore[T]||(e.IncludesShadersStore[T]=se);var E=`pbrBlockSheen`,ce=`#ifdef SHEEN
...
#endif
`;e.IncludesShadersStore[E]||(e.IncludesShadersStore[E]=ce);var D=`pbrBlockClearcoat`,O=`struct clearcoatOutParams
...
return outParams;}
#endif
`;e.IncludesShadersStore[D]||(e.IncludesShadersStore[D]=O);var k=`pbrBlockIridescence`,A=`struct iridescenceOutParams
...
#endif
`;e.IncludesShadersStore[k]||(e.IncludesShadersStore[k]=A);var j=`pbrBlockSubSurface`,M=`struct subSurfaceOutParams
...
return outParams;}
#endif
`;e.IncludesShadersStore[j]||(e.IncludesShadersStore[j]=M);var N=`pbrBlockNormalGeometric`,P=`vec3 viewDirectionW=normalize(vEyePosition.xyz-vPositionW);
#ifdef NORMAL
...
#endif
`;e.IncludesShadersStore[N]||(e.IncludesShadersStore[N]=P);var F=`pbrBlockNormalFinal`,I=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
#endif
`;e.IncludesShadersStore[F]||(e.IncludesShadersStore[F]=I);var L=`pbrBlockLightmapInit`,R=`#ifdef LIGHTMAP
...
#endif
`;e.IncludesShadersStore[L]||(e.IncludesShadersStore[L]=R);var z=`pbrBlockGeometryInfo`,B=`float NdotVUnclamped=dot(normalW,viewDirectionW);float NdotV=absEps(NdotVUnclamped);float alphaG=convertRoughnessToAverageSlope(roughness);vec2 AARoughnessFactors=getAARoughnessFactors(normalW.xyz);
#ifdef SPECULARAA
...
#endif
#endif
`;e.IncludesShadersStore[z]||(e.IncludesShadersStore[z]=B);var V=`pbrBlockReflectance0`,H=`float reflectanceF0=reflectivityOut.reflectanceF0;vec3 specularEnvironmentR0=reflectivityOut.colorReflectanceF0;vec3 specularEnvironmentR90=reflectivityOut.colorReflectanceF90;
#ifdef ALPHAFRESNEL
float reflectance90=fresnelGrazingReflectance(reflectanceF0);specularEnvironmentR90=specularEnvironmentR90*reflectance90;
#endif
`;e.IncludesShadersStore[V]||(e.IncludesShadersStore[V]=H);var U=`pbrBlockReflectance`,le=`#if defined(ENVIRONMENTBRDF) && !defined(REFLECTIONMAP_SKYBOX)
...
#endif
#endif
`;e.IncludesShadersStore[U]||(e.IncludesShadersStore[U]=le);var W=`pbrBlockDirectLighting`,ue=`vec3 diffuseBase=vec3(0.,0.,0.);
#ifdef SS_TRANSLUCENCY
...
#endif
`;e.IncludesShadersStore[W]||(e.IncludesShadersStore[W]=ue);var G=`pbrBlockFinalLitComponents`,de=`aggShadow=aggShadow/numLights;
#if defined(ENVIRONMENTBRDF)
...
#endif
#endif
`;e.IncludesShadersStore[G]||(e.IncludesShadersStore[G]=de);var K=`pbrBlockFinalUnlitComponents`,fe=`vec3 finalDiffuse=diffuseBase;finalDiffuse*=surfaceAlbedo;
...
`;e.IncludesShadersStore[K]||(e.IncludesShadersStore[K]=fe);var q=`pbrBlockFinalColorComposition`,pe=`vec4 finalColor=vec4(
#ifndef UNLIT
#ifdef REFLECTION
finalIrradiance +
#endif
...
`;e.IncludesShadersStore[q]||(e.IncludesShadersStore[q]=pe);var J=`pbrBlockImageProcessing`,me=`#if defined(IMAGEPROCESSINGPOSTPROCESS) || defined(SS_SCATTERING)
...
#endif
`;e.IncludesShadersStore[J]||(e.IncludesShadersStore[J]=me);var Y=`pbrBlockPrePass`,he=`float writeGeometryInfo=finalColor.a>ALPHATESTVALUE ? 1.0 : 0.0;
...
#endif
#endif
`;e.IncludesShadersStore[Y]||(e.IncludesShadersStore[Y]=he);var X=`pbrDebug`,Z=`#if DEBUGMODE>0
...
#endif
`;e.IncludesShadersStore[X]||(e.IncludesShadersStore[X]=Z);var ge=ee({pbrPixelShader:()=>_e}),Q=`pbrPixelShader`,$=`#define PBR_FRAGMENT_SHADER
...
`;e.ShadersStore[Q]||(e.ShadersStore[Q]=$);var _e={name:Q,shader:$};export{ge as t};