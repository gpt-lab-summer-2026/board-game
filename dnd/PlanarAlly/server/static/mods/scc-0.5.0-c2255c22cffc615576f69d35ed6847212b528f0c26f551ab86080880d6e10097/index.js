...
const _hoisted_19 = { class: "mod" };
const _hoisted_20 = { class: "prof" };
const _hoisted_21 = { class: "grid" };
const _hoisted_22 = { class: "inline" };
const _hoisted_23 = { class: "inline" };
const _hoisted_24 = { class: "attacks" };
const _hoisted_25 = { label: "Weapons" };
const _hoisted_26 = ["value"];
const _hoisted_27 = { label: "Natural" };
...
const _hoisted_56 = { class: "inline" };
...
const _hoisted_65 = ["id", "onUpdate:modelValue"];
const _hoisted_66 = ["id", "onUpdate:modelValue"];
const _hoisted_67 = ["id", "onUpdate:modelValue"];
const _hoisted_68 = ["title", "onClick"];
const _hoisted_69 = { class: "inline" };
const _hoisted_70 = ["disabled"];
const _hoisted_71 = { class: "grid" };
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("div", _hoisted_1, [
        ...
        createElementVNode("section", null, [
          _cache[52] || (_cache[52] = createElementVNode("h3", null, "Saving throws", -1)),
          createElementVNode("div", _hoisted_17, [
            (openBlock(true), createElementBlock(Fragment, null, renderList(unref(ABILITIES), (a) => {
              return openBlock(), createElementBlock("div", {
                ...
                createElementVNode("span", _hoisted_19, toDisplayString(unref(signed)(derived.value.saves[a.key].bonus)), 1),
                createElementVNode("span", _hoisted_20, toDisplayString(derived.value.saves[a.key].proficient ? "proficient" : " "), 1)
              ], 2);
            }), 128))
          ])
        ]),
        createElementVNode("section", null, [
          _cache[64] || (_cache[64] = createElementVNode("h3", null, "Combat", -1)),
          createElementVNode("div", _hoisted_21, [
            _cache[57] || (_cache[57] = createElementVNode("label", { for: "scc-hp" }, "Hit points", -1)),
            createElementVNode("div", _hoisted_22, [
              ...
              _cache[53] || (_cache[53] = createElementVNode("span", { class: "muted" }, "/", -1)),
              withDirectives(createElementVNode("input", {
              ...
              _cache[54] || (_cache[54] = createElementVNode("span", { class: "muted" }, "temp", -1)),
              withDirectives(createElementVNode("input", {
            ...
            _cache[58] || (_cache[58] = createElementVNode("label", { for: "scc-ac" }, "Armour class", -1)),
            createElementVNode("div", _hoisted_23, [
              ...
              _cache[55] || (_cache[55] = createElementVNode("label", {
                for: "scc-speed",
                class: "muted"
              }, "speed", -1)),
              withDirectives(createElementVNode("input", {
              ...
              _cache[56] || (_cache[56] = createElementVNode("span", { class: "muted" }, "ft", -1))
            ])
          ]),
          createElementVNode("table", _hoisted_24, [
            _cache[63] || (_cache[63] = createElementVNode("thead", null, [
            ...
            createElementVNode("tbody", null, [
              createElementVNode("tr", null, [
                _cache[60] || (_cache[60] = createElementVNode("th", { scope: "row" }, "Melee", -1)),
                ...
                createElementVNode("td", null, [
                  derived.value.melee ? (openBlock(), createElementBlock("code", _hoisted_29, toDisplayString(derived.value.melee.attack), 1)) : (openBlock(), createElementBlock("span", _hoisted_30, "—"))
                ]),
                createElementVNode("td", null, [
                  derived.value.melee ? (openBlock(), createElementBlock("code", _hoisted_31, toDisplayString(derived.value.melee.damage), 1)) : (openBlock(), createElementBlock("span", _hoisted_32, "—"))
                ])
              ]),
              createElementVNode("tr", null, [
                _cache[62] || (_cache[62] = createElementVNode("th", { scope: "row" }, "Ranged", -1)),
                createElementVNode("td", null, [
                  withDirectives(createElementVNode("select", {
                    ...
                    _cache[61] || (_cache[61] = createElementVNode("option", { value: null }, "—", -1)),
                    ...
                    rangedWeapons.value.natural.length > 0 ? (openBlock(), createElementBlock("optgroup", _hoisted_35, [
                ...
                createElementVNode("td", null, [
                  derived.value.ranged ? (openBlock(), createElementBlock("code", _hoisted_37, toDisplayString(derived.value.ranged.attack), 1)) : (openBlock(), createElementBlock("span", _hoisted_38, "—"))
                ]),
                createElementVNode("td", null, [
                  derived.value.ranged ? (openBlock(), createElementBlock("code", _hoisted_39, toDisplayString(derived.value.ranged.damage), 1)) : (openBlock(), createElementBlock("span", _hoisted_40, "—"))
                ])
              ])
            ])
          ]),
          _cache[65] || (_cache[65] = createElementVNode("p", { class: "muted small" }, " Attack rows are computed from ability scores, level and the equipped weapon. The ghost player rolls these exact numbers, and can roll any of them with advantage or disadvantage. ", -1))
        ]),
        isCaster.value ? (openBlock(), createElementBlock("section", _hoisted_41, [
          _cache[74] || (_cache[74] = createElementVNode("h3", null, "Spellcasting", -1)),
          createElementVNode("div", _hoisted_42, [
            _cache[67] || (_cache[67] = createElementVNode("label", { for: "scc-cantrip" }, "Cantrip", -1)),
              ...
              withDirectives(createElementVNode("select", {
                ...
                (openBlock(true), createElementBlock(Fragment, null, renderList(cantripChoices.value, (c) => {
                  return openBlock(), createElementBlock("option", {
                    key: c.id,
                    value: c.id
                  }, toDisplayString(c.name), 9, _hoisted_44);
                }), 128))
              ], 544), [
                [vModelSelect, unref(data).equipped.cantrip]
              ]),
              createElementVNode("span", _hoisted_45, toDisplayString((_a = klass.value) == null ? void 0 : _a.name) + " list · casts with " + toDisplayString((_b = spellAbility.value) == null ? void 0 : _b.toUpperCase()) + " · save DC " + toDisplayString(derived.value.spellSaveDc), 1)
            ])
          ]),
          derived.value.cantrip ? (openBlock(), createElementBlock("table", _hoisted_46, [
            createElementVNode("thead", null, [
              createElementVNode("tr", null, [
                _cache[68] || (_cache[68] = createElementVNode("th", null, "Cantrip", -1)),
                _cache[69] || (_cache[69] = createElementVNode("th", null, "Range", -1)),
                createElementVNode("th", null, toDisplayString(derived.value.cantrip.kind === "attack" ? "To hit" : "Save"), 1),
                _cache[70] || (_cache[70] = createElementVNode("th", null, "Damage", -1))
              ])
            ]),
            createElementVNode("tbody", null, [
              createElementVNode("tr", null, [
                createElementVNode("th", _hoisted_47, toDisplayString(derived.value.cantrip.name), 1),
                ...
                createElementVNode("td", null, [
                  derived.value.cantrip.attack ? (openBlock(), createElementBlock("code", _hoisted_48, toDisplayString(derived.value.cantrip.attack), 1)) : (openBlock(), createElementBlock("span", _hoisted_49, "DC " + toDisplayString(derived.value.cantrip.saveDc) + " " + toDisplayString((_c = derived.value.cantrip.save) == null ? void 0 : _c.toUpperCase()), 1))
                ]),
                createElementVNode("td", null, [
                  createElementVNode("code", null, toDisplayString(derived.value.cantrip.damage), 1),
                  createElementVNode("span", _hoisted_50, toDisplayString(derived.value.cantrip.damageType), 1)
                ])
              ])
            ])
          ])) : createCommentVNode("", true),
          ((_d = derived.value.cantrip) == null ? void 0 : _d.closeRangeDisadvantage) ? (openBlock(), createElementBlock("p", _hoisted_51, [
            _cache[71] || (_cache[71] = createTextVNode(" Ranged spell attack: ")),
            _cache[72] || (_cache[72] = createElementVNode("strong", null, "disadvantage", -1)),
            _cache[73] || (_cache[73] = createTextVNode(" while a hostile creature is within 5 ft — ")),
            createElementVNode("code", null, toDisplayString(derived.value.cantrip.attackDisadvantage), 1)
          ])) : createCommentVNode("", true),
          cantrip.value ? (openBlock(), createElementBlock("p", _hoisted_52, toDisplayString(cantrip.value.text), 1)) : createCommentVNode("", true),
          derived.value.cantrip ? (openBlock(), createElementBlock("p", _hoisted_53, " Cantrip damage scales with character level and takes no ability modifier. ")) : createCommentVNode("", true)
        ])) : createCommentVNode("", true),
        createElementVNode("section", null, [
          _cache[75] || (_cache[75] = createElementVNode("h3", null, "Description", -1)),
        ...
        properties.value !== void 0 ? (openBlock(), createElementBlock("section", _hoisted_54, [
          _cache[82] || (_cache[82] = createElementVNode("h3", null, "Token", -1)),
          createElementVNode("div", _hoisted_55, [
            _cache[80] || (_cache[80] = createElementVNode("label", { for: "scc-size" }, "Size", -1)),
            createElementVNode("div", _hoisted_56, [
              ...
              _cache[76] || (_cache[76] = createElementVNode("span", { class: "muted" }, "cells — 0 infers from the image", -1))
            ]),
            _cache[81] || (_cache[81] = createElementVNode("span", { id: "scc-token-flags-label" }, "Flags", -1)),
            createElementVNode("div", _hoisted_58, [
              createElementVNode("label", null, [
                ...
                _cache[77] || (_cache[77] = createTextVNode(" name visible "))
              ]),
              createElementVNode("label", null, [
                createElementVNode("input", {
                  type: "checkbox",
                ...
                _cache[78] || (_cache[78] = createTextVNode(" locked "))
              ]),
              createElementVNode("label", null, [
                createElementVNode("input", {
                  type: "checkbox",
                ...
                _cache[79] || (_cache[79] = createTextVNode(" defeated "))
              ])
            ])
          ])
        ])) : createCommentVNode("", true),
        createElementVNode("section", null, [
          _cache[84] || (_cache[84] = createElementVNode("h3", null, "Extra", -1)),
          createElementVNode("div", _hoisted_62, [
            (openBlock(true), createElementBlock(Fragment, null, renderList(unref(data).custom, (stat) => {
              return openBlock(), createElementBlock(Fragment, {
                ...
                createElementVNode("label", {
                  for: "scc-x-" + stat.name
                }, toDisplayString(stat.name), 9, _hoisted_63),
            ...
            _cache[83] || (_cache[83] = createElementVNode("label", { for: "scc-new-stat" }, "Add stat", -1)),
        ...
        createElementVNode("section", null, [
          ...
          createElementVNode("div", _hoisted_71, [
            ...
            _cache[87] || (_cache[87] = createElementVNode("label", { for: "scc-preset-name" }, "Save as", -1)),
          ...
          _cache[89] || (_cache[89] = createElementVNode("p", { class: "muted small" }, " Presets are shared by the whole campaign and are not tied to an asset, so a statline can be reused for any token. ", -1))
        ])
      ]);
    };
  }
...
const CharTab = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-e5a4a6fb"]]);
