...
const _hoisted_49 = { class: "passives" };
...
const _hoisted_53 = { class: "grid" };
const _hoisted_54 = { class: "inline" };
const _hoisted_55 = ["value"];
const _hoisted_56 = { class: "muted" };
const _hoisted_57 = {
  key: 0,
  class: "attacks"
};
const _hoisted_58 = { scope: "row" };
...
const _hoisted_71 = ["checked"];
const _hoisted_72 = ["checked"];
const _hoisted_73 = { class: "grid" };
const _hoisted_74 = ["for"];
const _hoisted_75 = { class: "inline" };
const _hoisted_76 = ["id", "onUpdate:modelValue"];
const _hoisted_77 = ["id", "onUpdate:modelValue"];
const _hoisted_78 = ["id", "onUpdate:modelValue"];
const _hoisted_79 = ["title", "onClick"];
const _hoisted_80 = { class: "inline" };
const _hoisted_81 = ["disabled"];
const _hoisted_82 = { class: "grid" };
const _hoisted_83 = { class: "inline" };
const _hoisted_84 = ["value"];
const _hoisted_85 = ["disabled"];
const _hoisted_86 = ["disabled"];
const _hoisted_87 = { class: "inline" };
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("div", _hoisted_1, [
        ...
        createElementVNode("section", null, [
          _cache[70] || (_cache[70] = createElementVNode("h3", null, "Combat", -1)),
          ...
          actions.value.length > 0 ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
            _cache[69] || (_cache[69] = createElementVNode("h3", { style: { "margin-top": "0.9rem" } }, "Weapon actions", -1)),
            createElementVNode("ul", _hoisted_49, [
              (openBlock(true), createElementBlock(Fragment, null, renderList(actions.value, (a) => {
                return openBlock(), createElementBlock("li", {
                  ...
                  createElementVNode("span", _hoisted_50, " · " + toDisplayString(a.source === "5e" ? "5e" : "house rule"), 1),
                  a.save ? (openBlock(), createElementBlock("span", _hoisted_51, " · " + toDisplayString(a.save.toUpperCase()) + " save", 1)) : createCommentVNode("", true),
                  createElementVNode("div", null, toDisplayString(a.text), 1)
                ]);
              }), 128))
            ])
          ], 64)) : createCommentVNode("", true),
          _cache[71] || (_cache[71] = createElementVNode("p", { class: "muted small" }, " Attack rows are computed from ability scores, level and the equipped weapon. The ghost player rolls these exact numbers, and can roll any of them with advantage or disadvantage. ", -1))
        ]),
        isCaster.value ? (openBlock(), createElementBlock("section", _hoisted_52, [
          _cache[80] || (_cache[80] = createElementVNode("h3", null, "Spellcasting", -1)),
          createElementVNode("div", _hoisted_53, [
            _cache[73] || (_cache[73] = createElementVNode("label", { for: "scc-cantrip" }, "Cantrip", -1)),
            createElementVNode("div", _hoisted_54, [
              withDirectives(createElementVNode("select", {
                ...
                _cache[72] || (_cache[72] = createElementVNode("option", { value: null }, "—", -1)),
                (openBlock(true), createElementBlock(Fragment, null, renderList(cantripChoices.value, (c) => {
                  return openBlock(), createElementBlock("option", {
                    key: c.id,
                    value: c.id
                  }, toDisplayString(c.name), 9, _hoisted_55);
                }), 128))
              ], 544), [
                [vModelSelect, unref(data).equipped.cantrip]
              ]),
              createElementVNode("span", _hoisted_56, toDisplayString((_a = klass.value) == null ? void 0 : _a.name) + " list · casts with " + toDisplayString((_b = spellAbility.value) == null ? void 0 : _b.toUpperCase()) + " · save DC " + toDisplayString(derived.value.spellSaveDc), 1)
            ])
          ]),
          derived.value.cantrip ? (openBlock(), createElementBlock("table", _hoisted_57, [
            createElementVNode("thead", null, [
              createElementVNode("tr", null, [
                _cache[74] || (_cache[74] = createElementVNode("th", null, "Cantrip", -1)),
                _cache[75] || (_cache[75] = createElementVNode("th", null, "Range", -1)),
                createElementVNode("th", null, toDisplayString(derived.value.cantrip.kind === "attack" ? "To hit" : "Save"), 1),
                _cache[76] || (_cache[76] = createElementVNode("th", null, "Damage", -1))
              ])
            ]),
            createElementVNode("tbody", null, [
              createElementVNode("tr", null, [
                createElementVNode("th", _hoisted_58, toDisplayString(derived.value.cantrip.name), 1),
                ...
                createElementVNode("td", null, [
                  derived.value.cantrip.attack ? (openBlock(), createElementBlock("code", _hoisted_59, toDisplayString(derived.value.cantrip.attack), 1)) : (openBlock(), createElementBlock("span", _hoisted_60, "DC " + toDisplayString(derived.value.cantrip.saveDc) + " " + toDisplayString((_c = derived.value.cantrip.save) == null ? void 0 : _c.toUpperCase()), 1))
                ]),
                createElementVNode("td", null, [
                  createElementVNode("code", null, toDisplayString(derived.value.cantrip.damage), 1),
                  createElementVNode("span", _hoisted_61, toDisplayString(derived.value.cantrip.damageType), 1)
                ])
              ])
            ])
          ])) : createCommentVNode("", true),
          ((_d = derived.value.cantrip) == null ? void 0 : _d.closeRangeDisadvantage) ? (openBlock(), createElementBlock("p", _hoisted_62, [
            _cache[77] || (_cache[77] = createTextVNode(" Ranged spell attack: ")),
            _cache[78] || (_cache[78] = createElementVNode("strong", null, "disadvantage", -1)),
            _cache[79] || (_cache[79] = createTextVNode(" while a hostile creature is within 5 ft — ")),
            createElementVNode("code", null, toDisplayString(derived.value.cantrip.attackDisadvantage), 1)
          ])) : createCommentVNode("", true),
          cantrip.value ? (openBlock(), createElementBlock("p", _hoisted_63, toDisplayString(cantrip.value.text), 1)) : createCommentVNode("", true),
          derived.value.cantrip ? (openBlock(), createElementBlock("p", _hoisted_64, " Cantrip damage scales with character level and takes no ability modifier. ")) : createCommentVNode("", true)
        ])) : createCommentVNode("", true),
        createElementVNode("section", null, [
          _cache[81] || (_cache[81] = createElementVNode("h3", null, "Description", -1)),
        ...
        properties.value !== void 0 ? (openBlock(), createElementBlock("section", _hoisted_65, [
          _cache[88] || (_cache[88] = createElementVNode("h3", null, "Token", -1)),
          createElementVNode("div", _hoisted_66, [
            _cache[86] || (_cache[86] = createElementVNode("label", { for: "scc-size" }, "Size", -1)),
            createElementVNode("div", _hoisted_67, [
              ...
              _cache[82] || (_cache[82] = createElementVNode("span", { class: "muted" }, "cells — 0 infers from the image", -1))
            ]),
            _cache[87] || (_cache[87] = createElementVNode("span", { id: "scc-token-flags-label" }, "Flags", -1)),
            createElementVNode("div", _hoisted_69, [
              createElementVNode("label", null, [
                ...
                _cache[83] || (_cache[83] = createTextVNode(" name visible "))
              ]),
              createElementVNode("label", null, [
                createElementVNode("input", {
                  type: "checkbox",
                ...
                _cache[84] || (_cache[84] = createTextVNode(" locked "))
              ]),
              createElementVNode("label", null, [
                createElementVNode("input", {
                  type: "checkbox",
                ...
                _cache[85] || (_cache[85] = createTextVNode(" defeated "))
              ])
            ])
          ])
        ])) : createCommentVNode("", true),
        createElementVNode("section", null, [
          _cache[90] || (_cache[90] = createElementVNode("h3", null, "Extra", -1)),
          createElementVNode("div", _hoisted_73, [
            (openBlock(true), createElementBlock(Fragment, null, renderList(unref(data).custom, (stat) => {
              return openBlock(), createElementBlock(Fragment, {
                ...
                createElementVNode("label", {
                  for: "scc-x-" + stat.name
                }, toDisplayString(stat.name), 9, _hoisted_74),
            ...
            _cache[89] || (_cache[89] = createElementVNode("label", { for: "scc-new-stat" }, "Add stat", -1)),
        ...
        createElementVNode("section", null, [
          _cache[94] || (_cache[94] = createElementVNode("h3", null, "Presets", -1)),
          createElementVNode("div", _hoisted_82, [
            _cache[92] || (_cache[92] = createElementVNode("label", { for: "scc-preset" }, "Load", -1)),
            createElementVNode("div", _hoisted_83, [
              withDirectives(createElementVNode("select", {
                id: "scc-preset",
                "onUpdate:modelValue": _cache[38] || (_cache[38] = ($event) => selectedPreset.value = $event)
              }, [
                _cache[91] || (_cache[91] = createElementVNode("option", { value: "" }, "—", -1)),
                (openBlock(true), createElementBlock(Fragment, null, renderList(presetNames.value, (name) => {
                  return openBlock(), createElementBlock("option", {
                    key: name,
                    value: name
                  }, toDisplayString(name), 9, _hoisted_84);
                }), 128))
              ], 512), [
                [vModelSelect, selectedPreset.value]
              ]),
            ...
            _cache[93] || (_cache[93] = createElementVNode("label", { for: "scc-preset-name" }, "Save as", -1)),
          ...
          _cache[95] || (_cache[95] = createElementVNode("p", { class: "muted small" }, " Presets are shared by the whole campaign and are not tied to an asset, so a statline can be reused for any token. ", -1))
        ])
      ]);
    };
  }
...
const CharTab = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-892264bf"]]);
