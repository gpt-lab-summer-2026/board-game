...
const _hoisted_101 = { class: "skill-grid" };
const _hoisted_102 = ["checked", "onChange"];
const _hoisted_103 = { class: "skill-name" };
const _hoisted_104 = { class: "muted" };
const _hoisted_105 = { key: 2 };
const _hoisted_106 = { class: "grid" };
const _hoisted_107 = { class: "inline" };
...
const _hoisted_111 = ["checked"];
const _hoisted_112 = ["checked"];
const _hoisted_113 = { class: "grid" };
const _hoisted_114 = ["for"];
const _hoisted_115 = { class: "inline" };
const _hoisted_116 = ["id", "onUpdate:modelValue"];
const _hoisted_117 = ["id", "onUpdate:modelValue"];
const _hoisted_118 = ["id", "onUpdate:modelValue"];
const _hoisted_119 = ["title", "onClick"];
const _hoisted_120 = { class: "inline" };
const _hoisted_121 = ["disabled"];
const _hoisted_122 = { class: "grid" };
const _hoisted_123 = { class: "inline" };
const _hoisted_124 = ["value"];
const _hoisted_125 = ["disabled"];
const _hoisted_126 = ["disabled"];
const _hoisted_127 = { class: "inline" };
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("div", _hoisted_1, [
        ...
        createElementVNode("section", null, [
          _cache[95] || (_cache[95] = createElementVNode("h3", null, "Skills", -1)),
          _cache[96] || (_cache[96] = createElementVNode("p", { class: "muted small" }, "Tick the ones this character is proficient in.", -1)),
          createElementVNode("div", _hoisted_101, [
            (openBlock(true), createElementBlock(Fragment, null, renderList(proficientSkills.value, (s) => {
              return openBlock(), createElementBlock("label", {
                ...
                }, null, 40, _hoisted_102),
                createElementVNode("span", _hoisted_103, toDisplayString(s.name), 1),
                createElementVNode("code", null, toDisplayString(unref(signed)(s.bonus)), 1),
                createElementVNode("span", _hoisted_104, toDisplayString(s.ability.toUpperCase()), 1)
              ]);
            }), 128))
          ])
        ]),
        createElementVNode("section", null, [
          _cache[97] || (_cache[97] = createElementVNode("h3", null, "Description", -1)),
        ...
        properties.value !== void 0 ? (openBlock(), createElementBlock("section", _hoisted_105, [
          _cache[104] || (_cache[104] = createElementVNode("h3", null, "Token", -1)),
          createElementVNode("div", _hoisted_106, [
            _cache[102] || (_cache[102] = createElementVNode("label", { for: "scc-size" }, "Size", -1)),
            createElementVNode("div", _hoisted_107, [
              ...
              }, null, 40, _hoisted_108),
              _cache[98] || (_cache[98] = createElementVNode("span", { class: "muted" }, "cells — 0 infers from the image", -1))
            ]),
            _cache[103] || (_cache[103] = createElementVNode("span", { id: "scc-token-flags-label" }, "Flags", -1)),
            createElementVNode("div", _hoisted_109, [
              createElementVNode("label", null, [
                ...
                _cache[99] || (_cache[99] = createTextVNode(" name visible "))
              ]),
              createElementVNode("label", null, [
                createElementVNode("input", {
                  type: "checkbox",
                ...
                _cache[100] || (_cache[100] = createTextVNode(" locked "))
              ]),
              createElementVNode("label", null, [
                createElementVNode("input", {
                  type: "checkbox",
                ...
                _cache[101] || (_cache[101] = createTextVNode(" defeated "))
              ])
            ])
          ])
        ])) : createCommentVNode("", true),
        createElementVNode("section", null, [
          _cache[106] || (_cache[106] = createElementVNode("h3", null, "Extra", -1)),
          createElementVNode("div", _hoisted_113, [
            (openBlock(true), createElementBlock(Fragment, null, renderList(unref(data).custom, (stat) => {
              return openBlock(), createElementBlock(Fragment, {
                ...
                createElementVNode("label", {
                  for: "scc-x-" + stat.name
                }, toDisplayString(stat.name), 9, _hoisted_114),
            ...
            _cache[105] || (_cache[105] = createElementVNode("label", { for: "scc-new-stat" }, "Add stat", -1)),
        ...
        createElementVNode("section", null, [
          _cache[110] || (_cache[110] = createElementVNode("h3", null, "Presets", -1)),
          createElementVNode("div", _hoisted_122, [
            _cache[108] || (_cache[108] = createElementVNode("label", { for: "scc-preset" }, "Load", -1)),
            createElementVNode("div", _hoisted_123, [
              withDirectives(createElementVNode("select", {
                id: "scc-preset",
                "onUpdate:modelValue": _cache[44] || (_cache[44] = ($event) => selectedPreset.value = $event)
              }, [
                _cache[107] || (_cache[107] = createElementVNode("option", { value: "" }, "—", -1)),
                (openBlock(true), createElementBlock(Fragment, null, renderList(presetNames.value, (name) => {
                  return openBlock(), createElementBlock("option", {
                    key: name,
                    value: name
                  }, toDisplayString(name), 9, _hoisted_124);
                }), 128))
              ], 512), [
                [vModelSelect, selectedPreset.value]
              ]),
            ...
            _cache[109] || (_cache[109] = createElementVNode("label", { for: "scc-preset-name" }, "Save as", -1)),
          ...
          _cache[111] || (_cache[111] = createElementVNode("p", { class: "muted small" }, " Presets are shared by the whole campaign and are not tied to an asset, so a statline can be reused for any token. ", -1))
        ])
      ]);
    };
  }
...
const CharTab = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-0f7c7679"]]);
