export interface EventMap {
    /**
     * A spell template was cast over these shapes.
     *
     * Emitted by the spell tool, consumed by whatever owns conditions --
     * the character sheet mod today. Keeping this a plain event is what
     * lets the core client stay ignorant of what a condition is.
     */
    "spell:cast": { shapes: unknown[]; condition?: string };
}
