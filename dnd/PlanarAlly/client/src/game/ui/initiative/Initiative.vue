    ...
    <Modal :visible="initiativeStore.state.showInitiative" :mask="false" extra-class="initiative-modal" @close="close">
        <template #header="m">
            <div class="modal-header" draggable="true" @dragstart="m.dragStart" @dragend="m.dragEnd">
                ...
                <button type="button" class="header-close" :title="t('common.close')" :aria-label="t('common.close')" @click.stop="close">
...
#initiative-list {
    ...
    min-width: 275px;
    margin: 2px 0;
    scrollbar-color: var(--pa-accent) white;

    > div:nth-child(odd) {
        background-color: var(--pa-accent-muted);
        scrollbar-color: var(--pa-accent) var(--pa-accent-muted);
    }
}
...
.initiative-entry {
    ...
    &.owned-actor {
        box-shadow:
            15px 0px 8px -10px var(--pa-accent),
            -15px 0px 8px -10px var(--pa-accent);
    }
}
...
.initiative-actor {
    ...
    &:hover {
        outline: solid 2px var(--pa-accent);
...
.initiative-effect {
    ...
    &.initiative-selected {
        ...
        scrollbar-color: var(--pa-accent-muted) var(--pa-accent);
    }
...
#initiative-settings {
    ...
    &:hover svg {
        ...
        filter: drop-shadow(0px 0px 3px var(--pa-accent));
    }
    &:active svg {
        scale: 95%;
    }
...
.initiative-bar-button {
    ...
    align-items: center;
    justify-content: center;
    border: solid 2px var(--pa-accent);
    border-radius: 5px;
    padding: 5px;
