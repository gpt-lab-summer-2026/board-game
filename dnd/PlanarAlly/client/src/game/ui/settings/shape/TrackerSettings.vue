...
<template>
    <div style="display: contents">
        <div id="trackers-panel">
            ...
            <div
                v-for="tracker of trackerSystem.state.trackers"
                :key="tracker.uuid"
                class="aura"
                :class="{ placeholder: tracker.temporary }"
            >
                <div class="summary">
            ...
            <div
                v-for="aura of auraSystem.state.auras"
                :key="aura.uuid"
                class="aura"
                :class="{ placeholder: aura.temporary }"
            >
                <div class="summary">
...
.aura {
    ...
    /*
     * PA always appends one empty "New tracker" / "New aura" row, which turns
     * into a real one as soon as you type in it. It was styled identically to
     * the rows above it, so a token with one tracker looked like it had two --
     * the second one confusingly named "New tracker". An outline instead of a
     * fill is the conventional way to say "this is where a new one goes".
     */
    &.placeholder > .summary {
        background-color: transparent;
        color: var(--pa-text-muted);
        border: dashed 2px var(--pa-border-strong);
        font-weight: normal;
        font-style: italic;
