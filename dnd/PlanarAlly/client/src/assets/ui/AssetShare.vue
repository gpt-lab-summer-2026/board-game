    ...
    <Modal :visible="visible" :colour="'transparent'">
        <template #header="m">
            <div class="modal-header" draggable="true" @dragstart="m.dragStart" @dragend="m.dragEnd">
                Asset Sharing
                <button type="button" class="header-close" :title="t('common.close')" :aria-label="t('common.close')" @click="emit('close')">
...
/* This dialog's frame is rounded, so its header rounds at the top only. */
.modal-header {
