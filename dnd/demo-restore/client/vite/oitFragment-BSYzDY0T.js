import{n as e}from"./rolldown-runtime-hePW80VL.js";import{t}from"./shaderStore-D-XQlhUT.js";var n=e({bumpFragmentWGSL:()=>a}),r=`bumpFragment`,i=`var uvOffset: vec2f= vec2f(0.0,0.0);
...
#endif
`;t.IncludesShadersStoreWGSL[o]||(t.IncludesShadersStoreWGSL[o]=s);var c=e({bumpFragmentFunctionsWGSL:()=>d}),l=`bumpFragmentFunctions`,u=`#if defined(BUMP)
...
#endif
`;t.IncludesShadersStoreWGSL[l]||(t.IncludesShadersStoreWGSL[l]=u);var d={name:l,shader:u},f=e({bumpFragmentMainFunctionsWGSL:()=>h}),p=`bumpFragmentMainFunctions`,m=`#if defined(BUMP) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC) || defined(DETAIL)
#if defined(TANGENT) && defined(NORMAL) 
...
#endif
`;t.IncludesShadersStoreWGSL[p]||(t.IncludesShadersStoreWGSL[p]=m);var h={name:p,shader:m},g=e({imageProcessingDeclarationWGSL:()=>y}),_=`imageProcessingDeclaration`,v=`#ifdef EXPOSURE
...
#endif
`;t.IncludesShadersStoreWGSL[_]||(t.IncludesShadersStoreWGSL[_]=v);var y={name:_,shader:v},b=e({imageProcessingFunctionsWGSL:()=>C}),x=`imageProcessingFunctions`,S=`#if TONEMAPPING==3
...
return vec4f(rgb,result.a);}`;t.IncludesShadersStoreWGSL[x]||(t.IncludesShadersStoreWGSL[x]=S);var C={name:x,shader:S},w=e({lightFragmentWGSL:()=>D}),T=`lightFragment`,E=`#ifdef LIGHT{X}
...
#endif
#endif
`;t.IncludesShadersStoreWGSL[T]||(t.IncludesShadersStoreWGSL[T]=E);var D={name:T,shader:E},O=e({lightUboDeclarationWGSL:()=>j}),k=`lightUboDeclaration`,A=`#ifdef LIGHT{X}
struct Light{X}
{vLightData: vec4f,
vLightDiffuse: vec4f,
...
#endif
#endif
`;t.IncludesShadersStoreWGSL[k]||(t.IncludesShadersStoreWGSL[k]=A);var j={name:k,shader:A},M=`ltcHelperFunctions`,N=`fn LTCUv(N: vec3f,V: vec3f,roughness: f32)->vec2f {var LUTSIZE: f32=64.0;var LUTSCALE: f32=( LUTSIZE-1.0 )/LUTSIZE;var LUTBIAS:f32=0.5/LUTSIZE;var dotNV:f32=saturate( dot( N,V ) );var uv:vec2f=vec2f( roughness,sqrt( 1.0-dotNV ) );uv=uv*LUTSCALE+LUTBIAS;return uv;}
...
vec3f( 0,1,0 ),
vec3f( 0,0,1 )
);result.Diffuse+=LTCEvaluate( normal,viewDir,position,mInvEmpty,rectCoords0,rectCoords1,rectCoords2,rectCoords3 );return result;}`;t.IncludesShadersStoreWGSL[M]||(t.IncludesShadersStoreWGSL[M]=N);var P=e({reflectionFunctionWGSL:()=>L}),F=`reflectionFunction`,I=`fn computeFixedEquirectangularCoords(worldPos: vec4f,worldNormal: vec3f,direction: vec3f)->vec3f
...
#endif
`;t.IncludesShadersStoreWGSL[F]||(t.IncludesShadersStoreWGSL[F]=I);var L={name:F,shader:I},R=e({shadowsFragmentFunctionsWGSL:()=>V}),z=`shadowsFragmentFunctions`,B=`#ifdef SHADOWS
#ifndef SHADOWFLOAT
...
#endif
`;t.IncludesShadersStoreWGSL[z]||(t.IncludesShadersStoreWGSL[z]=B);var V={name:z,shader:B},H=`prePassDeclaration`,U=`#ifdef PREPASS
...
#endif
#endif
`;t.IncludesShadersStoreWGSL[H]||(t.IncludesShadersStoreWGSL[H]=U);var W=`oitDeclaration`,G=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
#define MAX_DEPTH 99999.0
var oitDepthSamplerSampler: sampler;var oitDepthSampler: texture_2d<f32>;var oitFrontColorSamplerSampler: sampler;var oitFrontColorSampler: texture_2d<f32>;
#endif
`;t.IncludesShadersStoreWGSL[W]||(t.IncludesShadersStoreWGSL[W]=G);var K=`decalFragment`,q=`#ifdef DECAL
...
#endif
`;t.IncludesShadersStoreWGSL[K]||(t.IncludesShadersStoreWGSL[K]=q);var J=`depthPrePass`,Y=`#ifdef DEPTHPREPASS
fragmentOutputs.color= vec4f(0.,0.,0.,1.0);return fragmentOutputs;
#endif
`;t.IncludesShadersStoreWGSL[J]||(t.IncludesShadersStoreWGSL[J]=Y);var X=`oitFragment`,Z=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
...
#endif
`;t.IncludesShadersStoreWGSL[X]||(t.IncludesShadersStoreWGSL[X]=Z);export{b as a,c,w as i,n as l,P as n,g as o,O as r,f as s,R as t};