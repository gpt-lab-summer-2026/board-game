...
FONT_PATH = os.path.join(os.path.dirname(os.path.abspath(__file__)), "fonts", "Inter.ttf")
...
def detect_text(frame):
    ...
    # cv2.imshow("Detected Card Contour", display)
    # cv2.waitKey(0)
    # cv2.destroyWindow("Detected Card Contour")
    ...
    # cv2.imshow("OCR input", ocr_image)
    # cv2.waitKey(0)
