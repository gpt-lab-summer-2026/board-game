...
function defaultCatalogue() {
  return {
    ...
    classes: [
      ...
      { id: "wizard", name: "Wizard", hitDie: 6, primaryAbility: "int", savingThrows: ["int", "wis"], spellcastingAbility: "int", passive: { name: "Arcane Recovery", text: "Once per day on a short rest, recover spell slots totalling half your level, rounded up." } },
      { id: "cleric", name: "Cleric", hitDie: 8, primaryAbility: "wis", savingThrows: ["wis", "cha"], spellcastingAbility: "wis", passive: { name: "Divine Domain", text: "Your chosen domain grants extra spells and a domain feature at 1st level." } },
      ...
      { id: "beast", name: "Beast", hitDie: 10, primaryAbility: "str", savingThrows: ["str", "con"], passive: { name: "Keen Smell", text: "Advantage on Wisdom (Perception) checks that rely on smell. Fights with natural weapons and carries no equipment." } }
    ],
    cantrips: [
      { id: "fire-bolt", name: "Fire Bolt", kind: "attack", damage: "1d10", damageType: "fire", range: "120", text: "A mote of fire hurled at a target. Flammable objects not being worn or carried are ignited." },
      { id: "eldritch-blast", name: "Eldritch Blast", kind: "attack", damage: "1d10", damageType: "force", range: "120", text: "A beam of crackling energy." },
      { id: "ray-of-frost", name: "Ray of Frost", kind: "attack", damage: "1d8", damageType: "cold", range: "60", text: "On a hit, the target's speed is reduced by 10 feet until your next turn." },
      { id: "shocking-grasp", name: "Shocking Grasp", kind: "attack", damage: "1d8", damageType: "lightning", range: "touch", melee: true, text: "A melee spell attack. On a hit the target can't take reactions until its next turn. Advantage if it wears metal armour." },
      { id: "sacred-flame", name: "Sacred Flame", kind: "save", damage: "1d8", damageType: "radiant", range: "60", save: "dex", text: "No attack roll: the target makes a Dexterity save, taking damage on a failure. Cover gives no benefit." }
    ]
  };
}
let pending$1;
...
function castingAbility(sheet) {
  var _a;
  if (sheet.spellAbility !== null) return sheet.spellAbility;
...
const _hoisted_18 = { label: "Weapons" };
const _hoisted_19 = ["value"];
const _hoisted_20 = { label: "Natural" };
...
const _hoisted_26 = { label: "Weapons" };
...
const _hoisted_36 = { class: "inline" };
const _hoisted_37 = { value: null };
...
const _hoisted_55 = ["checked"];
const _hoisted_56 = ["checked"];
const _hoisted_57 = { class: "grid" };
const _hoisted_58 = ["for"];
const _hoisted_59 = { class: "inline" };
const _hoisted_60 = ["id", "onUpdate:modelValue"];
const _hoisted_61 = ["id", "onUpdate:modelValue"];
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("div", _hoisted_1, [
        createElementVNode("section", null, [
          _cache[49] || (_cache[49] = createElementVNode("h3", null, "Identity", -1)),
          createElementVNode("div", _hoisted_2, [
            _cache[44] || (_cache[44] = createElementVNode("label", { for: "scc-token-name" }, "Token name", -1)),
            ...
            _cache[45] || (_cache[45] = createElementVNode("label", { for: "scc-race" }, "Race", -1)),
            ...
            _cache[46] || (_cache[46] = createElementVNode("label", { for: "scc-background" }, "Background", -1)),
            withDirectives(createElementVNode("select", {
              id: "scc-background",
              ...
              _cache[42] || (_cache[42] = createElementVNode("option", { value: null }, "—", -1)),
            ...
            _cache[47] || (_cache[47] = createElementVNode("label", { for: "scc-class" }, "Class", -1)),
            withDirectives(createElementVNode("select", {
              id: "scc-class",
            ...
            _cache[48] || (_cache[48] = createElementVNode("label", { for: "scc-level" }, "Level", -1)),
        ...
        createElementVNode("section", null, [
          _cache[50] || (_cache[50] = createElementVNode("h3", null, "Abilities", -1)),
        ...
        createElementVNode("section", null, [
          _cache[62] || (_cache[62] = createElementVNode("h3", null, "Combat", -1)),
          createElementVNode("div", _hoisted_14, [
            _cache[55] || (_cache[55] = createElementVNode("label", { for: "scc-hp" }, "Hit points", -1)),
            createElementVNode("div", _hoisted_15, [
              ...
              _cache[51] || (_cache[51] = createElementVNode("span", { class: "muted" }, "/", -1)),
              withDirectives(createElementVNode("input", {
              ...
              _cache[52] || (_cache[52] = createElementVNode("span", { class: "muted" }, "temp", -1)),
              withDirectives(createElementVNode("input", {
            ...
            _cache[56] || (_cache[56] = createElementVNode("label", { for: "scc-ac" }, "Armour class", -1)),
            createElementVNode("div", _hoisted_16, [
              ...
              _cache[53] || (_cache[53] = createElementVNode("label", {
                for: "scc-speed",
                class: "muted"
              }, "speed", -1)),
              withDirectives(createElementVNode("input", {
              ...
              _cache[54] || (_cache[54] = createElementVNode("span", { class: "muted" }, "ft", -1))
            ])
          ]),
          createElementVNode("table", _hoisted_17, [
            _cache[61] || (_cache[61] = createElementVNode("thead", null, [
            ...
            createElementVNode("tbody", null, [
              createElementVNode("tr", null, [
                _cache[58] || (_cache[58] = createElementVNode("th", { scope: "row" }, "Melee", -1)),
                createElementVNode("td", null, [
                  withDirectives(createElementVNode("select", {
                    ...
                    _cache[57] || (_cache[57] = createElementVNode("option", { value: null }, "—", -1)),
                    createElementVNode("optgroup", _hoisted_18, [
                      (openBlock(true), createElementBlock(Fragment, null, renderList(meleeWeapons.value.carried, (w) => {
                        return openBlock(), createElementBlock("option", {
                          key: w.id,
                          value: w.id
                        }, toDisplayString(w.name), 9, _hoisted_19);
                      }), 128))
                    ]),
                    createElementVNode("optgroup", _hoisted_20, [
                      (openBlock(true), createElementBlock(Fragment, null, renderList(meleeWeapons.value.natural, (w) => {
                        return openBlock(), createElementBlock("option", {
                          key: w.id,
                          value: w.id
                        }, toDisplayString(w.name), 9, _hoisted_21);
                      }), 128))
                    ])
                  ], 544), [
                ...
                createElementVNode("td", null, [
                  derived.value.melee ? (openBlock(), createElementBlock("code", _hoisted_22, toDisplayString(derived.value.melee.attack), 1)) : (openBlock(), createElementBlock("span", _hoisted_23, "—"))
                ]),
                createElementVNode("td", null, [
                  derived.value.melee ? (openBlock(), createElementBlock("code", _hoisted_24, toDisplayString(derived.value.melee.damage), 1)) : (openBlock(), createElementBlock("span", _hoisted_25, "—"))
                ])
              ]),
              createElementVNode("tr", null, [
                _cache[60] || (_cache[60] = createElementVNode("th", { scope: "row" }, "Ranged", -1)),
                createElementVNode("td", null, [
                  withDirectives(createElementVNode("select", {
                    ...
                    _cache[59] || (_cache[59] = createElementVNode("option", { value: null }, "—", -1)),
                    createElementVNode("optgroup", _hoisted_26, [
                      (openBlock(true), createElementBlock(Fragment, null, renderList(rangedWeapons.value.carried, (w) => {
                        return openBlock(), createElementBlock("option", {
                          key: w.id,
                          value: w.id
                        }, toDisplayString(w.name), 9, _hoisted_27);
                      }), 128))
                    ]),
                    rangedWeapons.value.natural.length > 0 ? (openBlock(), createElementBlock("optgroup", _hoisted_28, [
                      (openBlock(true), createElementBlock(Fragment, null, renderList(rangedWeapons.value.natural, (w) => {
                        return openBlock(), createElementBlock("option", {
                          key: w.id,
                          value: w.id
                        }, toDisplayString(w.name), 9, _hoisted_29);
                      }), 128))
                    ])) : createCommentVNode("", true)
                  ], 544), [
                ...
                createElementVNode("td", null, [
                  derived.value.ranged ? (openBlock(), createElementBlock("code", _hoisted_30, toDisplayString(derived.value.ranged.attack), 1)) : (openBlock(), createElementBlock("span", _hoisted_31, "—"))
                ]),
                createElementVNode("td", null, [
                  derived.value.ranged ? (openBlock(), createElementBlock("code", _hoisted_32, toDisplayString(derived.value.ranged.damage), 1)) : (openBlock(), createElementBlock("span", _hoisted_33, "—"))
                ])
              ])
            ])
          ]),
          _cache[63] || (_cache[63] = createElementVNode("p", { class: "muted small" }, " Attack rows are computed from ability scores, level and the equipped weapon. The ghost player rolls these exact numbers, and can roll any of them with advantage or disadvantage. ", -1))
        ]),
        createElementVNode("section", null, [
          _cache[73] || (_cache[73] = createElementVNode("h3", null, "Spellcasting", -1)),
          createElementVNode("div", _hoisted_34, [
            _cache[65] || (_cache[65] = createElementVNode("label", { for: "scc-cantrip" }, "Cantrip", -1)),
            withDirectives(createElementVNode("select", {
              id: "scc-cantrip",
              ...
              (openBlock(true), createElementBlock(Fragment, null, renderList(unref(catalogue).cantrips, (c) => {
                return openBlock(), createElementBlock("option", {
                  key: c.id,
                  value: c.id
                }, toDisplayString(c.name), 9, _hoisted_35);
              }), 128))
            ], 544), [
              [vModelSelect, unref(data).equipped.cantrip]
            ]),
            _cache[66] || (_cache[66] = createElementVNode("label", { for: "scc-spell-ability" }, "Cast with", -1)),
            createElementVNode("div", _hoisted_36, [
              withDirectives(createElementVNode("select", {
                id: "scc-spell-ability",
                "onUpdate:modelValue": _cache[26] || (_cache[26] = ($event) => unref(data).spellAbility = $event),
                onChange: _cache[27] || (_cache[27] = //@ts-ignore
                (...args) => unref(save) && unref(save)(...args))
              }, [
                createElementVNode("option", _hoisted_37, toDisplayString(((_a = klass.value) == null ? void 0 : _a.spellcastingAbility) ? "From class" : "None — pick one to cast"), 1),
                (openBlock(true), createElementBlock(Fragment, null, renderList(unref(ABILITIES), (a) => {
                  return openBlock(), createElementBlock("option", {
                    key: a.key,
                    value: a.key
                  }, toDisplayString(a.long), 9, _hoisted_38);
                }), 128))
              ], 544), [
                [vModelSelect, unref(data).spellAbility]
              ]),
              spellAbility.value ? (openBlock(), createElementBlock("span", _hoisted_39, " using " + toDisplayString(spellAbility.value.toUpperCase()) + ", save DC " + toDisplayString(derived.value.spellSaveDc), 1)) : createCommentVNode("", true)
            ])
          ]),
          derived.value.cantrip ? (openBlock(), createElementBlock("table", _hoisted_40, [
            createElementVNode("thead", null, [
              createElementVNode("tr", null, [
                _cache[67] || (_cache[67] = createElementVNode("th", null, "Cantrip", -1)),
                _cache[68] || (_cache[68] = createElementVNode("th", null, "Range", -1)),
                createElementVNode("th", null, toDisplayString(derived.value.cantrip.kind === "attack" ? "To hit" : "Save"), 1),
                _cache[69] || (_cache[69] = createElementVNode("th", null, "Damage", -1))
              ])
            ]),
            createElementVNode("tbody", null, [
              createElementVNode("tr", null, [
                createElementVNode("th", _hoisted_41, toDisplayString(derived.value.cantrip.name), 1),
                ...
                createElementVNode("td", null, [
                  derived.value.cantrip.attack ? (openBlock(), createElementBlock("code", _hoisted_42, toDisplayString(derived.value.cantrip.attack), 1)) : (openBlock(), createElementBlock("span", _hoisted_43, "DC " + toDisplayString(derived.value.cantrip.saveDc) + " " + toDisplayString((_b = derived.value.cantrip.save) == null ? void 0 : _b.toUpperCase()), 1))
                ]),
                createElementVNode("td", null, [
                  createElementVNode("code", null, toDisplayString(derived.value.cantrip.damage), 1),
                  createElementVNode("span", _hoisted_44, toDisplayString(derived.value.cantrip.damageType), 1)
                ])
              ])
            ])
          ])) : createCommentVNode("", true),
          ((_c = derived.value.cantrip) == null ? void 0 : _c.closeRangeDisadvantage) ? (openBlock(), createElementBlock("p", _hoisted_45, [
            _cache[70] || (_cache[70] = createTextVNode(" Ranged spell attack: ")),
            _cache[71] || (_cache[71] = createElementVNode("strong", null, "disadvantage", -1)),
            _cache[72] || (_cache[72] = createTextVNode(" while a hostile creature is within 5 ft — ")),
            createElementVNode("code", null, toDisplayString(derived.value.cantrip.attackDisadvantage), 1)
          ])) : createCommentVNode("", true),
          cantrip.value ? (openBlock(), createElementBlock("p", _hoisted_46, toDisplayString(cantrip.value.text), 1)) : !spellAbility.value ? (openBlock(), createElementBlock("p", _hoisted_47, " This character has no spellcasting ability. Pick one above, or choose a caster class. ")) : createCommentVNode("", true),
          derived.value.cantrip ? (openBlock(), createElementBlock("p", _hoisted_48, " Cantrip damage scales with character level (5th, 11th, 17th) and takes no ability modifier. ")) : createCommentVNode("", true)
        ]),
        createElementVNode("section", null, [
          _cache[74] || (_cache[74] = createElementVNode("h3", null, "Description", -1)),
          withDirectives(createElementVNode("textarea", {
            "onUpdate:modelValue": _cache[28] || (_cache[28] = ($event) => unref(data).description = $event),
            rows: "4",
            onChange: _cache[29] || (_cache[29] = //@ts-ignore
            (...args) => unref(save) && unref(save)(...args))
          }, null, 544), [
            [vModelText, unref(data).description]
          ])
        ]),
        properties.value !== void 0 ? (openBlock(), createElementBlock("section", _hoisted_49, [
          _cache[81] || (_cache[81] = createElementVNode("h3", null, "Token", -1)),
          createElementVNode("div", _hoisted_50, [
            _cache[79] || (_cache[79] = createElementVNode("label", { for: "scc-size" }, "Size", -1)),
            createElementVNode("div", _hoisted_51, [
              createElementVNode("input", {
                ...
                onChange: _cache[30] || (_cache[30] = ($event) => setSize(Number($event.target.value)))
              }, null, 40, _hoisted_52),
              _cache[75] || (_cache[75] = createElementVNode("span", { class: "muted" }, "cells — 0 infers from the image", -1))
            ]),
            _cache[80] || (_cache[80] = createElementVNode("span", { id: "scc-token-flags-label" }, "Flags", -1)),
            createElementVNode("div", _hoisted_53, [
              createElementVNode("label", null, [
                createElementVNode("input", {
                  type: "checkbox",
                  checked: properties.value.nameVisible,
                  onChange: _cache[31] || (_cache[31] = ($event) => setNameVisible($event.target.checked))
                }, null, 40, _hoisted_54),
                _cache[76] || (_cache[76] = createTextVNode(" name visible "))
              ]),
              createElementVNode("label", null, [
                createElementVNode("input", {
                  type: "checkbox",
                  checked: properties.value.isLocked,
                  onChange: _cache[32] || (_cache[32] = ($event) => setLocked($event.target.checked))
                }, null, 40, _hoisted_55),
                _cache[77] || (_cache[77] = createTextVNode(" locked "))
              ]),
              createElementVNode("label", null, [
                createElementVNode("input", {
                  type: "checkbox",
                  checked: properties.value.isDefeated,
                  onChange: _cache[33] || (_cache[33] = ($event) => setDefeated($event.target.checked))
                }, null, 40, _hoisted_56),
                _cache[78] || (_cache[78] = createTextVNode(" defeated "))
              ])
            ])
          ])
        ])) : createCommentVNode("", true),
        createElementVNode("section", null, [
          _cache[83] || (_cache[83] = createElementVNode("h3", null, "Extra", -1)),
          createElementVNode("div", _hoisted_57, [
            (openBlock(true), createElementBlock(Fragment, null, renderList(unref(data).custom, (stat) => {
              return openBlock(), createElementBlock(Fragment, {
                ...
                createElementVNode("label", {
                  for: "scc-x-" + stat.name
                }, toDisplayString(stat.name), 9, _hoisted_58),
                createElementVNode("div", _hoisted_59, [
                  stat.type === "string" ? withDirectives((openBlock(), createElementBlock("input", {
                    ...
                    "onUpdate:modelValue": ($event) => stat.value = $event,
                    type: "checkbox",
                    onChange: _cache[36] || (_cache[36] = //@ts-ignore
                    (...args) => unref(save) && unref(save)(...args))
                  }, null, 40, _hoisted_62)), [
            ...
            _cache[82] || (_cache[82] = createElementVNode("label", { for: "scc-new-stat" }, "Add stat", -1)),
            createElementVNode("div", _hoisted_64, [
              withDirectives(createElementVNode("input", {
                id: "scc-new-stat",
                "onUpdate:modelValue": _cache[37] || (_cache[37] = ($event) => selectedName.value = $event),
                type: "text",
                placeholder: "name"
              }, null, 512), [
              ...
              withDirectives(createElementVNode("select", {
                "onUpdate:modelValue": _cache[38] || (_cache[38] = ($event) => selectedOption.value = $event)
              }, [
        ...
        createElementVNode("section", null, [
          ...
          createElementVNode("div", _hoisted_66, [
            ...
            _cache[86] || (_cache[86] = createElementVNode("label", { for: "scc-preset-name" }, "Save as", -1)),
            createElementVNode("div", _hoisted_71, [
              withDirectives(createElementVNode("input", {
                id: "scc-preset-name",
                "onUpdate:modelValue": _cache[40] || (_cache[40] = ($event) => presetName.value = $event),
                type: "text",
          ...
          _cache[88] || (_cache[88] = createElementVNode("p", { class: "muted small" }, " Presets are shared by the whole campaign and are not tied to an asset, so a statline can be reused for any token. ", -1))
        ])
      ]);
    };
  }
...
const CharTab = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-e5f46f3a"]]);
let api;
